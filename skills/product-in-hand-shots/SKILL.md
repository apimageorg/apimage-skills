...
`product-scale-reference`, `inpainting-product-fixes`, `lifestyle-product-photography`, `model-wearing-product`, `product-image-qa-review`, `background-replacement-scenes`
